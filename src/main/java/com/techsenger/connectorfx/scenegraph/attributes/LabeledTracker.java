    ...
    private @Nullable Attribute<?> read(Labeled label, String property) {
        return switch (property) {
            ...
            case "contentDisplay" -> new Attribute<>(
                ...
                DisplayHint.ENUM,
                ValueState.defaultIf(label.getContentDisplay() == null
                        || label.getContentDisplay() == ContentDisplay.LEFT),
            ...
            case "textAlignment" -> new Attribute<>(
                ...
                DisplayHint.ENUM,
                ValueState.defaultIf(label.getTextAlignment() == null
                        || label.getTextAlignment() == TextAlignment.LEFT),
